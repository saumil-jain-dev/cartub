                                    ...
                                    <div class="tab-content" id="ver-pills-tabContent">
                                        <div class="tab-pane fade show active" id="ver-pills-general">
                                            ...
                                            @foreach ($settingsData as $setting)
                                                @if ($setting->key == 'is_testing')
                                                    <div class="row mb-3 align-items-center">
                                                        <label class="col-md-3 form-label">{{ $setting->title }}</label>
                                                        <div class="col-md-9">
                                                ...
                                                @else
                                                    <div class="row"><label
                                                            class="col-md-3 form-label">{{ $setting->title }}</label>
                                                        <div class="col-md-9">
                                                            <div class="input-group"><input class="form-control"
                                                                    type="text" placeholder="Enter min order amount"
                                                                    name="{{ $setting->key }}"
