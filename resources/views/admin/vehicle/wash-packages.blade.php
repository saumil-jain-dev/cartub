...
<div class="container-fluid e-category">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="common-align gap-2 justify-content-start">
                                                @if (hasPermission('vehicle.wash-packages-edit'))
    ...
    <div class="modal fade" id="addWashTypeModal" tabindex="-1" aria-labelledby="addWashTypeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="addWashTypeForm" method="POST" action="{{ route('vehicle.wash-packages-store') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="addWashTypeModalLabel">Add Wash Package</h5>
    ...
    <div class="modal fade" id="editWashTypeModal" tabindex="-1" aria-labelledby="editWashTypeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="editWashTypeForm" method="POST" action="{{ route('vehicle.wash-packages-edit') }}">
            @csrf
            <input type="hidden" name="id" id="edit_id">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="editWashTypeModalLabel">Edit Wash Package</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <div class="mb-3">
...
<script>
    ...
    $(document).on('click', '.delete-wash-type', function() {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "This will delete the wash package and all its permissions.",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `${site_url}/admin/vehicle/wash-package/destroy/${roleId}`,
                    type: 'GET',
                    data: {
