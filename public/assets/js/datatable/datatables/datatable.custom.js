(function ($) {
  $(document).ready(function () {
    ...
    // Enroute car Wash
    $("#enroute-cleaner-table").DataTable({
      pageLength: 4,
      autoWidth: false,
      lengthChange: false,
      info: false,
    ...
    // Inprogress car Wash
    $("#in-progress-car-table").DataTable({
      pageLength: 4,
      autoWidth: false,
      lengthChange: false,
      info: false,
    ...
    // Completed car Wash
    $("#completed-car-wash-table").DataTable({
      pageLength: 4,
      autoWidth: false,
      lengthChange: false,
      info: false,
    ...
    function format(d) {
      ...
      return `
      <table width="100%" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">
        <tr>
          <td>Add Products:</td>
          <td>${d.addProducts}</td>
        </tr>
    ...
    let manageReview = $("#customer-feedback-table").DataTable({
      columnDefs: [
        {
          orderable: false,
          render: $.fn.dataTable.render.select(),
    ...
    $("#customer-feedback-table tbody").on("click", "td.details-control", function () {
    ...
    $("#customer-vehicles-list").DataTable({
      columnDefs: [
        {
          orderable: false,
          render: $.fn.dataTable.render.select(),
