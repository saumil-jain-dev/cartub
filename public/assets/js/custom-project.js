...
(function () {
  ...
  // Car wash summery chart
  var summary_chat_option = {
    series: [30, 20, 15, 25, 40], // Example data counts or %
    chart: {
      height: 260,
      type: "radialBar",
      toolbar: { show: false }
    ...
    colors: ["#29C5F6", "#F57F17", "#26A69A", "#54BA4A", "#ffb829"],
    labels: ["Pending", "Assigned", "Enroute", "In Progress", "Completed"],
    legend: {
      show: false
    },
    responsive: [
  ...
  var summary_chat = new ApexCharts(document.querySelector("#car-wash-summary-chart"), summary_chat_option);
  summary_chat.render();
  ...
  var monthlyExpense = {
    ...
    colors: ["var(--theme-default)", "rgba(41, 197, 246, 0.13)", "rgba(115, 102, 255, 0.33)", "rgba(115, 102, 255, 0.62)", "rgba(115, 102, 255, 0.09)"],
    responsive: [
      {
        breakpoint: 1698,
        options: {
  ...
  var projectChart = {
    ...
    colors: ["#29C5F6", "#838383", "#ffb829", "#65c15c"],
