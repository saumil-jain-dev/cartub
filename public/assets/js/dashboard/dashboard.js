...
(function () {
  ...
  var packageChart = {
    ...
    colors: ["#29C5F6", "#8D83FF"],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
        type: "vertical",
        gradientToColors: ["#29C5F6", "#8D83FF"],
        opacityFrom: 0.98,
        opacityTo: 0.85,
        stops: [0, 100],
      },
  ...
  var deliveryDuration = {
    ...
    colors: ["rgba(131, 131, 131, 0.3)", "#29C5F6"],
    fill: {
      type: "solid",
      gradient: {
        shade: "dark",
...
var bookingTrendWeekly = {
  series: [
    {
      name: "Bookings",
      data: [45, 60, 75, 50, 90, 80, 70], // Replace with actual data
    },
  ],
  chart: {
    height: 300,
...
var chart = new ApexCharts(document.querySelector("#bookingTrendWeeklyChart"), bookingTrendWeekly);
chart.render();
...
yaxis: {
  min: 0,
  max: 70, // since your column values go up to 60
  tickAmount: 5,
  labels: {
    formatter: (val) => val,
    style: {
  ...
  colors: ["#29C5F6", "rgba(41, 197, 246, 0.1)"],
  legend: {
    show: false
  },
};

var chart = new ApexCharts(document.querySelector("#market-graph"), options);
chart.render();
